...
public class HelloMotionTrackingActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button button = (Button) findViewById(R.id.target_button);
        button.setOnClickListener(new Button.OnClickListener(){
            public void onClick(View v){
                String XS = ((EditText) findViewById(R.id.targetX)).getText().toString();
                String YS = ((EditText) findViewById(R.id.targetY)).getText().toString();
...
//                TangoPoseData.COORDINATE_FRAME_AREA_DESCRIPTION));
     ...
     */
    private void logPose(final TangoPoseData pose) {
